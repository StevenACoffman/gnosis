...
*   May 16th, 2015
*   by [Christian](/authors/christian/)
*   • [Twitter](https://www.twitter.com/ctietze)

![](https://vg08.met.vgwort.de/na/77a7fbd9835b46eca87dc5203bef48c3)
...
[![construction site](/img/blog/201505160917_constructionsite.jpg)](/img/blog/201505160917_constructionsite.jpg)

Photo credit: ["The steel"](https://www.flickr.com/photos/dalec/4840828941/) by [Dale C](https://www.flickr.com/photos/dalec/) on flickr. Licensed under [CC-NC-ND.](https://creativecommons.org/licenses/by-nc-nd/2.0/)

A system of categories adheres to [common sense](http://web.archive.org/web/20140822053423/http://takingnotenow.blogspot.com/2009/10/darnton-on-commonplace-books.html). Supposedly, there’s a hierarchy of topics “out there” which you can represent with categories. I don’t believe in a natural order of things, but we can agree upon this: throughout human history, shared taxonomies have proven useful. Some taxonomies are limited to your particular workplace or your craft, like where incoming mail should be filed, some are shared among a language community. They help retrieve information in a commonly understood way.
...
The proverbial [empty slate](http://en.wikipedia.org/wiki/Tabula_rasa) is a good metaphor in this case. When you learn something new, you collect information and make sense of it afterward. If you know something related, your brain will make use of existing information to speed up the process. This can be called [assimilation](http://web.archive.org/web/20160305015224/http://www.learningandteaching.info/learning/assimacc.htm): new stuff is learned in a way to make use of existing stuff. Existing neural pathways are used. This is the case when you learn the first words of a new language: you translate and remember. Then there’s the mode of [accommodation](http://web.archive.org/web/20160305015224/http://www.learningandteaching.info/learning/assimacc.htm), where we start to change the way we think to better understand the object of our interest. That’s when you can let go of your first language to understand the new one. (All of this was very coarse now and hand-wavingly simplified.)
...
*   Tags:
    *   [category](/posts/tags/category/)
    *   [keywords](/posts/tags/keywords/)
...
var vanilla\_forum\_url = 'https://forum.zettelkasten.de'; var vanilla\_identifier = '/posts/no-categories/'; var vanilla\_category\_id = '11'; var vanilla\_title = 'Why Categories for Your Note Archive are a Bad Idea'; var vanilla\_discussion\_id = ''; /\*\*\* DON'T EDIT BELOW THIS LINE \*\*\*/ (function() { var vanilla = document.createElement('script'); vanilla.type = 'text/javascript'; var timestamp = new Date().getTime(); vanilla.src = vanilla\_forum\_url + '/js/embed.js'; (document.getElementsByTagName('head')\[0\] || document.getElementsByTagName('body')\[0\]).appendChild(vanilla); })();

Please enable JavaScript to view the [comments powered by Vanilla.](http://vanillaforums.com/?ref_noscript)

var disqus\_shortname = 'zettelkastende'; var disqus\_identifier = '/posts/no-categories/'; var disqus\_title = 'Why Categories for Your Note Archive are a Bad Idea'; var disqus\_url = 'https://zettelkasten.de/posts/no-categories/'; (function() { var dsq = document.createElement('script'); dsq.type = 'text/javascript'; dsq.async = true; dsq.src = '//' + disqus\_shortname + '.disqus.com/embed.js'; (document.getElementsByTagName('head')\[0\] || document.getElementsByTagName('body')\[0\]).appendChild(dsq); })();
